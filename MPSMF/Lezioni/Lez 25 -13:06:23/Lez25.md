...
Prendiamo un qualsiasi derivato, ci chiediamo se esiste un portafoglio fatto da bond e stock che al tempo finale eguaglia il valore dell'opzione asiatica? Se sì, allora l'opzione asiatica può essere replicata, altrimenti no.

![Schermata del 2023-06-17 16-28-26.png](/home/festinho/Immagini/Schermate/Schermata%20del%202023-06-17%2016-28-26.png)
...
![Schermata del 2023-06-17 15-58-55.png](/home/festinho/Immagini/Schermate/Schermata%20del%202023-06-17%2015-58-55.png)
...
![](/home/festinho/.var/app/com.github.marktext.marktext/config/marktext/images/2023-06-17-16-00-07-Schermata%20del%202023-06-17%2015-59-53.png)

![Schermata del 2023-06-17 16-00-34.png](/home/festinho/Immagini/Schermate/Schermata%20del%202023-06-17%2016-00-34.png)

Si scopre che il portafoglio che replica il derivato è il valore scontato del derivato al tempo precedente, la 3.99.

Quindi ciò che facciamo è andare "all'indietro".
Alla fine, il primo valore assunto $W_0$ è composto da valori del portafoglio che replicano il derivato che sono esattamente i valori scontati del valore finale del derivato rispetto la probabilità neutrale al rischio. 

Tale risultato si può ottenere anche nel caso del derivato dipendente da tutta la storia del processo, anche se lo svolgimento è più complicato.

L'idea dietro è comunque la medesima.

###### Prezzo di non arbitraggio

![](/home/festinho/.var/app/com.github.marktext.marktext/config/marktext/images/2023-06-17-16-01-44-Schermata%20del%202023-06-17%2016-01-34.png)
...
![](/home/festinho/.var/app/com.github.marktext.marktext/config/marktext/images/2023-06-17-16-04-59-Schermata%20del%202023-06-17%2016-04-45.png)
...
![Schermata del 2023-06-17 16-05-41.png](/home/festinho/Immagini/Schermate/Schermata%20del%202023-06-17%2016-05-41.png)
...
![Schermata del 2023-06-17 16-06-51.png](/home/festinho/Immagini/Schermate/Schermata%20del%202023-06-17%2016-06-51.png)

***Corollario 216,*** ad ogni istante la call è sempre positiva. Se sconto variabile positiva, il risultato è variabile positiva.

![Schermata del 2023-06-17 16-07-40.png](/home/festinho/Immagini/Schermate/Schermata%20del%202023-06-17%2016-07-40.png)

**Definizione 217**, come caso particolare c'è la **proposizione 218**. 

![](/home/festinho/.var/app/com.github.marktext.marktext/config/marktext/images/2023-06-17-16-08-42-Schermata%20del%202023-06-17%2016-08-32.png)

Un risultato è dato dal **Corollario 219**, dove ho relazione tra il valore del titolo e il valore K (parte positiva). Al tempo N diventa un'uguaglianza, per tutti i valori inferiori ad N è una disuguaglianza.

![](/home/festinho/.var/app/com.github.marktext.marktext/config/marktext/images/2023-06-17-16-09-53-Schermata%20del%202023-06-17%2016-09-07.png)
...
![](/home/festinho/.var/app/com.github.marktext.marktext/config/marktext/images/2023-06-17-16-13-20-Schermata%20del%202023-06-17%2016-13-08.png)Le variabili sono $r$ ed $S_n$, ovviamente se ho una delle due stimo l'altra.
...
![](/home/festinho/.var/app/com.github.marktext.marktext/config/marktext/images/2023-06-17-16-14-15-Schermata%20del%202023-06-17%2016-14-05.png)
...
![](/home/festinho/.var/app/com.github.marktext.marktext/config/marktext/images/2023-06-17-16-16-04-Schermata%20del%202023-06-17%2016-15-45.png)

![](/home/festinho/.var/app/com.github.marktext.marktext/config/marktext/images/2023-06-17-16-17-05-Schermata%20del%202023-06-17%2016-16-41.png)
...
Con il rispettivo americano, magari trovo un precedente sopra $K$, ma $K$ non viene *scontato*. Se esercitassi AC avrei:
$C_n>A_{C_n}$, il fatto che ad ogni payoff considero K e non lo scontato K, rende l'esercizio della opzione anticipata non vantaggioso. La disuguaglianza di prima genere un arbitraggio sul mercato. La gente non la esercita perchè ci sono arbitraggi, allora alla fine sono come quelle europee. 

![Schermata del 2023-06-17 16-47-34.png](/home/festinho/Immagini/Schermate/Schermata%20del%202023-06-17%2016-47-34.png)

$C_n \geq max\{S_n - \frac{K}{(1+r)^n}\}$ 
$AC_n= max \{S_n-K,0\}$

Per le PUT il discorso è diverso. 
L'idea è:
...
<img src="file:///home/festinho/.var/app/com.github.marktext.marktext/config/marktext/images/2023-06-17-16-23-55-Schermata%20del%202023-06-17%2016-23-35.png" title="" alt="" width="619">

Come faccio a stabilire quando conviene esercitare la PUT?

Vista **Proposizione 230, 231**. (per un progetto, posso verificare se la 231 è verificata). 

![](/home/festinho/.var/app/com.github.marktext.marktext/config/marktext/images/2023-06-17-16-24-29-Schermata%20del%202023-06-17%2016-24-17.png)

Queste sono disuguaglianze, ma se volessi valore esatto?

Introduco il concetto del *tempo ottimale di esercizio*, che è più complesso. E' un problema di *ottimizzazione stocastica*, sto cercando di massimizzarlo. **Definizione 232**. 

![Schermata del 2023-06-17 16-24-44.png](/home/festinho/Immagini/Schermate/Schermata%20del%202023-06-17%2016-24-44.png)

Lì $N$ è il numero di intervalli in cui è stato diviso lo spazio. Gli eventi $w$ in cui la la variabile aleatoria $v$ prende valori $\leq n$, posso osservare in corso d'opera, perchè ho l'informazione fino ad $n$. $\mathcal{F}_n$ è la filtrazione.

Visto esempio 234.

![Schermata del 2023-06-17 16-25-34.png](/home/festinho/Immagini/Schermate/Schermata%20del%202023-06-17%2016-25-34.png)

$w_1$ può essere 0 o 1, qualunque sia $w$, essa è una successione che può partire da 0 o 1.
...
Per $v_2$ abbiamo problema con $E_{0,0}\cup E_{1,0}$ che però non appartiene. Quindi il problema è che nel secondo caso so che avrei dovuto prendere un certo valore al tempo x, DOPO che il tempo X è passato.
Visto **teorema 235**:

![Schermata del 2023-06-17 16-26-49.png](/home/festinho/Immagini/Schermate/Schermata%20del%202023-06-17%2016-26-49.png)
