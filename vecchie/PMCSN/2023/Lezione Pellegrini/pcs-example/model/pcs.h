...
#define CHECK_CHANNEL(P, I)                                                                                            \
	(CHECK_CHANNEL_BIT(((unsigned int *)(((struct entity_state *)P)->channel_state))[(int)((int)I / BITS)],        \
	    ((int)I % BITS)))
#define SET_CHANNEL(P, I)                                                                                              \
	(SET_CHANNEL_BIT(((unsigned int *)(((struct entity_state *)P)->channel_state))[(int)((int)I / BITS)],          \
	    ((int)I % BITS)))
#define RESET_CHANNEL(P, I)                                                                                            \
	(RESET_CHANNEL_BIT(((unsigned int *)(((struct entity_state *)P)->channel_state))[(int)((int)I / BITS)],        \
	    ((int)I % BITS)))
